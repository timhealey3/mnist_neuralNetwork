...
assert(X_test.shape[0] == y_train.shape[0]), "Number of test images is != to number of labels"
...
model = create_model()
model.fix(X_train, y_train, validation_split, epochs = 10, batch_size = 200, verbose = 1, shuffle = 1)
